// Blog thumbnail — NEW-flow Step 4 prompt.
//
// Distinct from the generic IMAGE_GENERATION_SYSTEM_PROMPT_WITH_BRAND —
// thumbnail has its own dedicated prompt in both flows. Paste the body
...
export const BLOG_THUMBNAIL_SYSTEM_PROMPT_NEW = `
<role>
...
export const BLOG_THUMBNAIL_USER_TEMPLATE_NEW = `
<base_description>
